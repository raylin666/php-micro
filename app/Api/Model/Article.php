...
class Article extends Model
{
     ...
     */
    protected array $fillable = ['id', 'title', 'author', 'summary', 'cover', 'sort', 'recommend_flag', 'commented_flag', 'status', 'view_count', 'comment_count', 'collection_count', 'zan_count', 'share_count', 'user_id', 'last_commented_at', 'created_at', 'updated_at'];
    ...
    {
        $join = self::join('article_extend', 'article.id', '=', 'article_extend.article_id')
            ->where('article.id', $id)
            ->select([
